/** Twemoji-style flags (viewBox 0 0 36 36), scaled via CSS class. */

interface FlagProps {
  className?: string;
}

export function FlagIconEn({ className }: FlagProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 36 36"
...
export function FlagIconBg({ className }: FlagProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 36 36"
